...
class ArgParserSpec extends WordSpecLike with Matchers {
  ...
  "Arguments" must {
    ...
    "be parsed correctly" in {
      val args = Array("-h", "hello", "-p", "9001", "-i", "mustafackim", "-r", "192.168.0.1:1337, 192.168.0.2:1338", "-s", "12")

      ArgParser(args) should be (Configuration("hello", 9001, "mustafackim", Seq(("192.168.0.1", 1337), ("192.168.0.2", 1338)), 12))
    }

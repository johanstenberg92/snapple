...
object TORSet extends ThriftStructCodec3[TORSet] {
  ...
  val ElementTypeField = new TField("elementType", TType.I32, 1)
  ...
  trait Proxy extends TORSet {
    ...
    override def elementType: Int = _underlying_TORSet.elementType
  ...
  with java.io.Serializable
{
      ...
      case _root_.scala.None => {
        val _fieldOpt: _root_.scala.Option[TField] =
          _fieldId match {
            case 1 =>
              if (true) {
                writeElementTypeValue(elementType, _oprot)
                _root_.scala.Some(TORSet.ElementTypeField)
              } else {
                _root_.scala.None
              }
            case 2 =>
  ...
  def setField(_blob: TFieldBlob): TORSet = {
    var elementType: Int = this.elementType
    ...
    _blob.id match {
      case 1 =>
        elementType = readElementTypeValue(_blob.read)
      case 2 =>
   ...
   * from the passthroughFields map, if present.
   */
  def unsetElementType: TORSet = unsetField(1)
